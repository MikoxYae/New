...
#         • Rewrites the constants inside plugins/premium_system/premium_auto.py
#           and plugins/premium_system/admin_orders.py using a regex
...
import plugins.premium_system.premium_auto as _pa
import plugins.premium_system.admin_orders as _ao
