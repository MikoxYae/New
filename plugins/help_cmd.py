...
USER_TXT = (
    ...
    "🔹 <b>ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ</b>\n"
    "ᴏᴘᴇɴ /start → <code>ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ</code>. ᴘɪᴄᴋ ᴀ ᴘʟᴀɴ "
    "(<code>1ʜ ₹1</code>, <code>1ᴅ ₹10</code>, <code>7ᴅ ₹50</code>, "
    "<code>30ᴅ ₹150</code>) → sᴄᴀɴ ᴜᴘɪ Qʀ → ᴘᴀʏ ᴛʜᴇ ᴇxᴀᴄᴛ ᴀᴍᴏᴜɴᴛ → "
...
OWNER_ORDERS_TXT = (
    ...
    "🔸 <b>/id</b> [<code>today</code>|<code>yesterday</code>|<code>DD-MM-YYYY</code>]\n"
    ...
    "🔸 <b>/ord</b> <code>&lt;user_id&gt;</code>\n"
    "sʜᴏᴡ ᴀʟʟ ᴏʀᴅᴇʀs ᴏғ ᴀ sᴘᴇᴄɪғɪᴄ ᴜsᴇʀ.\n"
    "<i>ᴇxᴀᴍᴘʟᴇ:</i> <code>/ord 7137144805</code>\n\n"
    "🔸 <b>/amount</b> [<code>today</code>|<code>yesterday</code>|<code>DD-MM-YYYY</code>]\n"
    ...
    "🔸 <b>/checkorder</b> <code>&lt;order_id&gt;</code>\n"
    ...
    "🔸 <b>/forceverify</b> <code>&lt;order_id&gt;</code>\n"
...
OWNER_PREMIUM_TXT = (
    ...
    "🔸 <b>/addpremium</b> <code>&lt;user_id&gt;</code> <code>&lt;duration&gt;</code>\n"
    ...
    "🔸 <b>/remove_premium</b> <code>&lt;user_id&gt;</code>\n"
...
OWNER_LINK_TXT = (
    ...
    "ᴄᴏᴘɪᴇs ᴇxᴀᴄᴛʟʏ ᴏɴᴄᴇ (ᴠ1.5 ғɪx) — ɴᴏ ᴅᴜᴘᴇs, ɴᴏ STOP-ᴊᴜɴᴋ-ʟɪɴᴋ.\n"
...
OWNER_BC_TXT = (
    "<b>📢 ʙʀᴏᴀᴅᴄᴀsᴛs</b>\n\n"
    "🔸 <b>/broadcast</b>  <i>(ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ)</i>\n"
    ...
    "🔸 <b>/pbroadcast</b>  <i>(ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ)</i>\n"
    ...
    "🔸 <b>/dbroadcast</b> <code>&lt;seconds&gt;</code>  <i>(ʀᴇᴘʟʏ)</i>\n"
...
OWNER_STATS_TXT = (
    ...
    "ʀᴇǫᴜᴇsᴛ ᴍᴏᴅᴇ, ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇ, sʜᴏʀᴛᴇɴᴇʀ, ᴄᴀᴘᴛɪᴏɴ, ᴀɴᴛɪ-ʙʏᴘᴀss, "
    "ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ, ᴇᴛᴄ.\n"
