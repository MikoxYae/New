    ...
    if data == "help":
        ...
        await client.send_photo(
            ...
            caption=(
                ...
                f"<b>Step 2 Send /premium_mode</b>\n"
                f"<b>Step 3 Select Your Choice Normal Premium | Super Premium</b>\n\n"
                f"<b>What You Get In Premium</b>\n\n"
                f"<b>1: About Normal Premium</b>\n"
                f"<b>No Need To Take Token.</b>\n"
                f"<b>You Can't Forward Our Content.</b>\n\n"
                f"<b>2: About Super Premium</b>\n"
                f"<b>• No Need To Take Token.</b>\n"
                f"<b>• You Can Forward Our Content.</b>\n\n"
                f"<b>Note : All Price And Details Are Given In That Bot.</b>\n\n"
